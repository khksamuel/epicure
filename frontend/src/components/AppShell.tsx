      ...
      <div className="mx-auto max-w-6xl px-4 py-5 sm:px-6 sm:py-8 lg:px-8">
        ...
        <footer className="mt-16 border-t border-ink/15 py-8 text-sm text-pencil sm:flex sm:items-center sm:justify-between">
          <a
            ...
            className="inline-flex items-center justify-center rounded-full border border-ink/15 bg-paper p-2 text-moss transition hover:border-moss/40 hover:bg-leaf/10"
            href="https://github.com/khksamuel/epicure"
            rel="noreferrer"
            target="_blank"
          >
            <svg
